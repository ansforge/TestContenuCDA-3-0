...
<!-- 
    ...
    Contenu :
        Contrôle de l'élement abstractStandardIndustryClassCode par rapport aux JDV définis dans CI-SIS_StructurationMinimale.sch
    Paramètres d'appel :
...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="abstractStandardIndustryClassCode" abstract="true" 
    ...
    <rule context="$xpath_elt">
        ...
        <assert test="(not(@nullFlavor) or $nullFlavor)">
            [abstractStandardIndustryClassCode] L'élément "<value-of select="$vue_elt"/>" ne doit pas comporter d'attribut nullFlavor.
        </assert> 
