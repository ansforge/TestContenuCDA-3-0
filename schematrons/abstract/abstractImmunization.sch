...
<!-- 
    ...
    Contenu :
        Contrôle de l'élement code par rapport aux JDV définis dans CI-SIS_ModelesDeContenusCDA.sch
    ...
    Historique :
        14/12/2022 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="abstractImmunization" abstract="true" 
