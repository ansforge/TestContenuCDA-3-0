...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CI-SIS_CNAM-HR_2021.01"
        ...
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Entete/Entete_CNAM-HR.sch"/>
        ...
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Entrees/E_FR-DispositifMedical_CNAM-HR.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Entrees/E_FR-HistoriquePrisesEnChargeMedicales_CNAM-HR.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Entrees/E_FR-Traitement_CNAM-HR.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Entrees/E_FR-Vaccination_CNAM-HR.sch"/>
        
        <!-- Sections -->      
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Sections/S_CommentaireNonCodee-CISIS.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Sections/S_DispositifsMedicaux-CISIS.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Sections/S_HistoriquePriseEnChargeMedicale.sch"/> 
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Sections/S_Traitements-CISIS.sch"/>
        <include href="include/specificationsVolets/CNAM-HR_2021.01/Sections/S_Vaccinations-CISIS.sch"/> 
        ...
        <pattern id="variables">
                ...
                <rule context="cda:ClinicalDocument/cda:component/cda:structuredBody">
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.4.1.2.16']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Commentaire-non-code (1.3.6.1.4.1.19376.1.4.1.2.16) pour la mention "Usage et Responsabilités" doit être présente.
                        </assert>
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.19']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Traitements (1.3.6.1.4.1.19376.1.5.3.1.3.19) doit être présente.
                        </assert>
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Vaccinations (1.3.6.1.4.1.19376.1.5.3.1.3.23) doit être présente.
                        </assert>
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.2.250.1.213.1.1.2.1']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Dispositifs-medicaux (1.2.250.1.213.1.1.2.1) doit être présente.
                        </assert>
                        <assert test="cda:component/cda:section/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.5.3.3']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Historique-prises-en-charge-medicales (1.3.6.1.4.1.19376.1.5.3.1.1.5.3.3) doit être présente.
                        </assert>
                        <assert test="cda:component/cda:section[cda:code/cda:translation[@code='67803-7']]/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Actes-et-interventions (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11) doit être présente avec un code/translation="67803-7" pour les "Soins médicaux et dentaires".
                        </assert>
                        <assert test="cda:component/cda:section[cda:code/cda:translation[@code='18726-0']]/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section FR-Actes-et-interventions (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11) doit être présente avec un code/translation="18726-0" pour les "Actes de radiologie".
                        </assert>
                        <assert test="cda:component/cda:section[cda:code/cda:translation[@code='26436-6']]/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11']"> 
                                [CI-SIS_CNAM-HR_2021.01] Erreur de conformité : La section "FR-Actes-et-interventions (1.3.6.1.4.1.19376.1.5.3.1.1.13.2.11) doit être présente avec un code/translation="26436-6" pour les "Actes de biologie".
                        </assert>
                </rule>
