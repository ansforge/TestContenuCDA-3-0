...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_neurologic_CSE-CS8">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.35"]'>
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="Q03.9"'>
            [E_neurologic_CSE-CS8] Erreur de conformité : L'entrée FR-Probleme de code "Q03.9" est obligatoire pour indiquer l'absence ou la présence d'une 'Hydrocéphalie'.
        </assert>        
        
        <!-- Vérifier que l'entrée FR-Certitude est présente dans l'entrée 'Hydrocéphalie' -->
        <assert test='.//cda:entry/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.37" and cda:value/@code="Q03.9"]/cda:entryRelationship/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.171"]/cda:code/@code="66455-7"'>
            [E_neurologic_CSE-CS8] Erreur de conformité : L'entrée FR-Certitude de code "66455-7" est obligatoire dans l'entrée 'Hydrocéphalie'.
        </assert>
    </rule>
