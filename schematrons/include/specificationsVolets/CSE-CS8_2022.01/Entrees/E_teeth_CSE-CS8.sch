...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_teeth_CSE-CS8">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.23"]'>
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="Q37"'>
            [E_teeth_CSE-CS8] Erreur de conformité : L'entrée FR-Probleme de code "Q37" est obligatoire pour indiquer l'absence ou la présence d'une 'Fente (labio-) palatine'.
        </assert>
