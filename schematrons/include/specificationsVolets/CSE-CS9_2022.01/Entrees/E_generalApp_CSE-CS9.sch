...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_generalApp_CSE-CS9">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.16"]'>       
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="Q89.7"'>
            [E_generalApp_CSE-CS9] Erreur de conformité : L'entrée FR-Probleme de code "Q89.7" est obligatoire pour indiquer l'absence ou la présence de Syndrome polymalformatif.
        </assert>
        
        <!-- Vérifier que l'entrée 'Trisomie 21' est présente -->
        <assert test='.//cda:entry/cda:observation/cda:value/@code="Q90"'>
            [E_generalApp_CSE-CS9] Erreur de conformité : L'entrée FR-Probleme de code "Q90" est obligatoire pour indiquer l'absence ou la présence de trisomie 21.
        </assert>
        
        <!-- Vérifier que l'entrée 'Aberrations chromosomiques' est présente -->
        <assert test='.//cda:entry/cda:observation/cda:value/@code="Q99.9"'>
            [E_generalApp_CSE-CS9] Erreur de conformité : L'entrée FR-Probleme de code "Q99.9" est obligatoire pour indiquer l'absence ou la présence d'Aberrations chromosomiques.
        </assert>
