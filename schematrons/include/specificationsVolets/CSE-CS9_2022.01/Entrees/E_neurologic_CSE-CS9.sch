...
<!-- E_neurologic_CSE-CS9
    
    Vérification des entrées FR-Probleme de la sous-section Système nerveux du CSE-CS9 
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_neurologic_CSE-CS9">
    <title>Vérification des entrées FR-Probleme de la sous-section Système nerveux du CSE-CS9</title>
