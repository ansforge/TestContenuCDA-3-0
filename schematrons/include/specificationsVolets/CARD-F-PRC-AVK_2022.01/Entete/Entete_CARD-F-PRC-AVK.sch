...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="Entete_CARD-F-PRC-AVK">
    ...
    <rule context="cda:ClinicalDocument">
        ...
        <assert test="./count(cda:setId[@root])=1"> 
            [Entete_CARD-F-PRC-AVK] Erreur de conformité : L'élément "setId" doit être présent. 
        </assert>
        <assert test="./count(cda:versionNumber[@value])=1"> 
            [Entete_CARD-F-PRC-AVK] Erreur de conformité : L'élément "versionNumber" doit être présent. 
        </assert>
    </rule>
