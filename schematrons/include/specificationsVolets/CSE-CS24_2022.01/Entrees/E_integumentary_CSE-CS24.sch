...
<!-- E_integumentary_CSE-CS24
    
    Vérification des entrées FR-Probleme de la sous-section Système tégumentaire du CSE-CS24 
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_integumentary_CSE-CS24">
    <title>Vérification des entrées FR-Probleme de la sous-section Système tégumentaire du CSE-CS24</title>
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.17"]'>
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="L30.9"'> 
            [E_integumentary_CSE-CS24] Erreur de conformité :
            L'entrée FR-Probleme de code "L30.9" est obligatoire pour indiquer l'absence ou la présence d'eczéma.
        </assert>        
