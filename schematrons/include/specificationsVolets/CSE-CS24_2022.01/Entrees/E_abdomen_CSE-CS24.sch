...
<!-- E_abdomen_CSE-CS24.sch
    
    Vérification des entrées FR-Probleme de la sous-section Système digestif du CSE-CS24
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_abdomen_CSE-CS24">
    <title>Vérification des entrées FR-Probleme de la sous-section Système digestif du CSE-CS24</title>
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.31"]'>
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="K21"'>
            [E_abdomen_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "K21" est obligatoire pour indiquer l'absence ou la présence de reflux gastroœsophagien.
        </assert>
        ...
        <assert test='.//cda:entry/cda:observation/cda:value/@code="GEN-092.01.02"'>
            [E_abdomen_CSE-CS24] Erreur de conformité : L'entrée FR-Probleme de code "GEN-092.01.02" est obligatoire pour indiquer l'absence ou la présence d'une autre affection du système digestif.
        </assert>
