...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_respiratory_CSE-CS24">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.1.9.30"]'>
        ...
        <assert test='(.//cda:entry/cda:observation/cda:value/@code="E84")'>
            ...
            L'entrée FR-Probleme de code "E84" est obligatoire pour indiquer l'absence ou la présence de Fibrose kystique.
        </assert>
        
        <!-- Observation: Asthme -->
        <assert test='not(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.5.3"]) or
            (.//cda:entry/cda:observation/cda:value/@code="J45")'>
            [E_respiratory_CSE-CS24] Erreur de conformité : 
            L'entrée FR-Probleme de code "J45" est obligatoire pour indiquer l'absence ou la présence d'Asthme.
        </assert>
