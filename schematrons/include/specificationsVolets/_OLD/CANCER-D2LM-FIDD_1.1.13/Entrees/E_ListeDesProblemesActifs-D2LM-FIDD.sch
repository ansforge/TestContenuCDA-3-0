...
<!-- 
   ...
   D2LM_FIDD : CR de seconde lecture de mammographie - Fiche d'interprétation de diagnostic différé
   auteur : ANS
   ......................................................................................................................................................    
    Historique :
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_ListeDesProblemesActifs-D2LM-FIDD">
        <rule context="/*:component/*:section[*:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.6']/*:entry/*:act[*:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']">
            ...
            <assert test="count(*:entryRelationship[@typeCode='REFR']/*:templateId[@root ='1.3.6.1.4.1.19376.1.5.3.1.4.13'] ) = count(*:entryRelationship[@typeCode='REFR'])">
                [E_ListeDesProblemesActifs-D2LM-FIDD] l'élement entryRelationship ayant un attribut @typeCode="REFR" doit avoir un templateId  "1.3.6.1.4.1.19376.1.5.3.1.4.13"
            </assert> 
            ...
            <assert test="count(*:entryRelationship[@typeCode='SUBJ']/*:templateId[@root ='1.3.6.1.4.1.19376.1.5.3.1.4.5'] ) = count(*:entryRelationship[@typeCode='SUBJ'])">
                [E_ListeDesProblemesActifs-D2LM-FIDD] L'élement entryRelationship ayant un attribut @typeCode="SUBJ" doit avoir un templateId  "1.3.6.1.4.1.19376.1.5.3.1.4.5"
            </assert> 
            ...
            <assert test="*:entryRelationship[@typeCode='SUBJ']/$EntréeProblèmeVal">
                [E_ListeDesProblemesActifs-D2LM-FIDD] La valeur de l'entrée Problème doit avoir l'attribut @code='C00-D48'
            </assert>
