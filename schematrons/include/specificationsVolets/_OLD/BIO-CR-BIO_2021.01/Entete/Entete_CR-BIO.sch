...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="Entete_CR-BIO">
    ...
    <rule context='cda:ClinicalDocument'>         
        ...
        <assert test='cda:templateId[@root="1.3.6.1.4.1.19376.1.3.3" and @extension="2021.01"]'>
            [Entete_CR-BIO] L'élément templateId fixé à @root="1.3.6.1.4.1.19376.1.3.3" et @extension="2021.01" est obligatoire
        </assert>
    </rule>
