...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_DICOM_CatalogueObjets_IMG-CR-IMG">
    ...
    <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.2.217"]'>
        ...
        <!-- Vérifier les contraintes pour l'élément code au niveau de l'entrée FR-DICOM-Examen-imagerie-->
        ...
        <!-- Vérifier les contraintes pour l'élement Study Instance UUID (id) et effectiveTime au niveau de l'entrée FR-DICOM-Examen-imagerie-->
        <assert test="not(.//cda:act[cda:templateId/@root='1.2.250.1.213.1.1.3.155']) or (.//cda:act[cda:templateId/@root='1.2.250.1.213.1.1.3.155'] and 
            .//cda:act[cda:templateId/@root='1.2.250.1.213.1.1.3.155']/cda:id and
            .//cda:act[cda:templateId/@root='1.2.250.1.213.1.1.3.155']/cda:effectiveTime)">
            [S_DICOM_CatalogueObjets_IMG-CR-IMG] Erreur de conformité au modèle IMG-CR-IMG : Si elle existe, l'entrée  FR-DICOM-Examen-imagerie (1.2.250.1.213.1.1.3.155) doit avoir obligatoirement l'id (Study Instance UUID) et l'effectiveTime (Date et heure de l'examen).
        </assert>
