...
<!-- 
    E_humanPatientWithNonHumanSubject_int.sch :
    Contenu :
        Contrôle d'un élément subject transportant un 'Human Patient with Non-Human Subject' 
        dans un élément <Sujbect> selon template défini par le profil IHE-PALM 
    Paramètres d'appel :
        Néant
    Historique :
        28/12/2023 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_humanPatientWithNonHumanSubject_int">
    <p>Contrôle d'un élément 'Human Patient with Non-Human Subject' dans un élément Sujbect</p>
