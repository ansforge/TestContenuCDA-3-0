...
<!-- 
    ...
    Historique :
        ...
        01/12/20 : Renommé
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_imageIllustrative_ANS">
    <p>Contrôle d'une image illustrative dans un élément observationMedia</p>
    <rule context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.103']">
        ...
        <assert test="../cda:observationMedia[@classCode = 'OBS' and @moodCode = 'EVN' and @ID]"> 
            [E_imageIllustrative_ANS] Erreur de Conformité CI-SIS : 
        ...
        <assert test="cda:value[(@mediaType = 'image/gif' or @mediaType = 'image/jpeg' or @mediaType = 'image/png'or @mediaType='image/bm') and @representation = 'B64']"> 
            [E_imageIllustrative_ANS] Erreur de Conformité CI-SIS : 
            L'image doit être un gif, un png ou un jpeg ou bm encodé en base 64 dans le sous-élément value. </assert> 
