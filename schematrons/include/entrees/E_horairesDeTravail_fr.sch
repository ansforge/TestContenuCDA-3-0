...
<!--                  -=<<o#%@O[ E_horairesDeTravail_fr.sch ]O@%#o>>=-
    
    Teste la conformité de l'entrée FR-Horaires-de-travail (1.2.250.1.213.1.1.3.70)
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_horairesDeTravail_fr">
    <title>CI-SIS horaire de travail </title>
    <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.3.70"]'>
        ...
        <assert test="cda:templateId/@root='1.2.250.1.213.1.1.3.70'">
