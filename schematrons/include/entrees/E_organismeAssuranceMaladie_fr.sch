...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_organismeAssuranceMaladie_fr">
    ...
    <rule context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.18']/cda:participant[@typeCode='HLD']">
        ...
        <assert test="cda:participantRole[@classCode='INDIV']"> 
            [E_organismeAssuranceMaladie_fr.sch] : Erreur de conformité CI-SIS : Le composant "participant" doit comporter un élément "participantRole"avec l'attribut @classCode est fixé à 'INDIV'.
        </assert>
    </rule>
</pattern>