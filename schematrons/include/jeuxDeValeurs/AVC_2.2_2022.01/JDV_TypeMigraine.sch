...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeMigraine" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:act/cda:entryRelationship/cda:observation/cda:value[@code='G43.0']/cda:qualifier/cda:value"/>
