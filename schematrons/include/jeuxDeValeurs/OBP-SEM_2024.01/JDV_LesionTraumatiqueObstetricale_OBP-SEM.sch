...
<!-- 
    JDV_LesionTraumatiqueObstetricale_OBP-SEM.sch :
    Contenu :
...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_LesionTraumatiqueObstetricale_OBP-SEM" is-a="dansJeuDeValeurs">
    <p></p>
    <param name="path_jdv" value="$jdv_LesionTraumatiqueObstetricale_OBP-SEM"/>
