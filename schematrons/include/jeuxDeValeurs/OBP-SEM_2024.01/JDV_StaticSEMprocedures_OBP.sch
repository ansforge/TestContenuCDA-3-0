...
<!-- 
    ...
    22/08/2023 : MAJ du schematron
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_StaticSEMprocedures_OBP" is-a="dansJeuDeValeurs">
    <p>Conformité des demandes d'examen complémentaires</p>
    <param name="path_jdv" value="$jdv_StaticSEMprocedures_OBP"/>
