...
<!-- 
    ...
    Historique :        
        01/06/2021 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeAnalgesie-CISIS" is-a="abstractEncompassingEncounterCode">
    <p></p>
    <param name="path_jdv1" value="$JDV_TypeAnalgesie-CISIS"/>
