...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypePres-CISIS" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:component/cda:section/cda:entry/cda:observation[cda:code/@code='MED-1248']/cda:value"/>
