...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_DateCons-CISIS" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:observation[cda:code/@code='75200-6']/cda:value"/>
