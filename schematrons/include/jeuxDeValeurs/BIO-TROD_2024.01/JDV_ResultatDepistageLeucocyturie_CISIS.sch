...
<!-- 
    ...
    Paramètres d'appel :
      - path_jdv : chemin relatif du JDV_ResultatDepistageLeucocyturie_CISIS.xml (jdv_ResultatDepistageLeucocyturie_CISIS a été valorisé à ../jeuxDeValeurs/JDV_ResultatDepistageLeucocyturie_CISIS.xml dans le schématron CI-SIS_BIO-ATTEST-DEPIST.sch) 
    ...
    Historique :
        ...
        03/06/2024 : MAJ
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_ResultatDepistageLeucocyturie_CISIS" is-a="dansJeuDeValeurs">
    <p>Conformité du résultat du test de dépistage</p>
    <param name="path_jdv" value="$JDV_ResultatDepistageLeucocyturie_CISIS"/>
