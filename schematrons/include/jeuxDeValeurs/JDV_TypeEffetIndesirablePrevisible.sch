...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeEffetIndesirablePrevisible" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_typeEffetIndesirablePrevisible"/>
