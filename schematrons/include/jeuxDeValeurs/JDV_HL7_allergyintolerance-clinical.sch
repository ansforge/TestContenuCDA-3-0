...
<!-- 
    JDV_HL7_allergyintolerance-clinical.sch (spécialisation du pattern dansJeuDeValeurs.sch)
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_HL7_allergyintolerance-clinical" is-a="dansJeuDeValeurs">
    <p>Conformité PCC du statut de santé d'un patient</p>
    <param name="path_jdv" value="$jdv_HL7_allergyintolerance-clinical"/>
