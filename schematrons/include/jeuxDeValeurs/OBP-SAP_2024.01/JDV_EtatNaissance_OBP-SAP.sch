...
<!-- JDV_EtatNaissance_OBP-SAP

    Historique :
    
    21/08/2023 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_EtatNaissance_OBP-SAP" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$JDV_EtatNaissance_OBP-SAP"/>
