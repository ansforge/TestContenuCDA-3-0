...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_NiveauEtude-CISIS" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.13.4' and cda:code/cda:qualifier/cda:value/@code='82589-3']/cda:value"/>
