...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_Acte_OBP-SNM" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="cda:section[cda:templateId/@root='1.2.250.1.213.1.1.2.118']/cda:entry/cda:procedure[cda:templateId/@root='1.2.250.1.213.1.1.3.62']/cda:code"/>
