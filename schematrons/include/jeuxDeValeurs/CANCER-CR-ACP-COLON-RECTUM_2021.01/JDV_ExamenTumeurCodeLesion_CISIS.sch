...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_ExamenTumeurCodeLesion_CISIS" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_ExamenTumeurCodeLesion_CISIS"/>
    ...
    <param name="xpath_elt" value="cda:procedure[cda:templateId/@root='1.3.6.1.4.1.19376.1.8.1.4.9' 
        and cda:code/@code='MED-864']/cda:value"/>
