...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TNM_pTNM_pT_CISIS" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_TNM_pTNM_pT_CISIS"/>
    ...
    <param name="xpath_elt" value="
        cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.138' and cda:code/@code='MED-830']/cda:value|
