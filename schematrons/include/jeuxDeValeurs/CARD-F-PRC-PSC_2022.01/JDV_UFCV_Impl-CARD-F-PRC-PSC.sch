...
<!-- 
   JDV_UFCV_Impl-CARD-F-PRC-PSC.sch :
    Contenu :
    ...
    Historique :
        05/01/2023 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_UFCV_Impl-CARD-F-PRC-PSC" is-a="dansJeuDeValeurs">
    <p>Conformité CI-SIS de la localisation</p>
    <param name="path_jdv" value="$jdv_UFCV_Impl-CARD-F-PRC-PSC"/>
