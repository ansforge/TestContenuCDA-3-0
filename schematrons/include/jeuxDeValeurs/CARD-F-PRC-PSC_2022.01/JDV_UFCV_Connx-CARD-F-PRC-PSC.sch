...
<!-- 
   JDV_UFCV_Connx-CARD-F-PRC-PSC.sch :
    Contenu :
    ...
    Historique :
        07/02/2022 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_UFCV_Connx-CARD-F-PRC-PSC" is-a="dansJeuDeValeurs">
    <p>Conformité CI-SIS de la connexion</p>
    <param name="path_jdv" value="$jdv_UFCV_Connx-CARD-F-PRC-PSC"/>
