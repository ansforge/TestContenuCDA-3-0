...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_TypeHistoEtatTumoral-CISIS" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$JDV_TypeHistoEtatTumoral-CISIS"/>
    <param name="vue_elt"
