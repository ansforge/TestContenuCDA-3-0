...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_HL7_ObservationIntoleranceType-CISIS" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$jdv_HL7_ObservationIntoleranceType-CISIS"/>
