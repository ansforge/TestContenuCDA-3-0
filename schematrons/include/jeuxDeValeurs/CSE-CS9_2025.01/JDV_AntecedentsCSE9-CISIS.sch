...
<!-- 
    ...
    Historique :
        27/10/2023 : Création
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_AntecedentsCSE9-CISIS" is-a="dansJeuDeValeurs">
    <p>Conformité des antécèdents</p>
    <param name="path_jdv" value="$JDV_AntecedentsCSE9-CISIS"/>
