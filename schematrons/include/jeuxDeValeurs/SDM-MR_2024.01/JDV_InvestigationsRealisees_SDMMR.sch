...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_InvestigationsRealisees_SDMMR" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:act/cda:entryRelationship/cda:observation/cda:entryRelationship/cda:observation[cda:code/@code='ORG-017']/cda:value"/>
