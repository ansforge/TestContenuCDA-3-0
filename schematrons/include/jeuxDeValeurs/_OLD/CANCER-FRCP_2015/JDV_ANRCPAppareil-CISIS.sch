...
-->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_ANRCPAppareil-CISIS" is-a="dansJeuDeValeurs">
    <p>Conformité Appareil</p>
    <param name="path_jdv" value="$JDV_ANRCPAppareil-CISIS"/>
