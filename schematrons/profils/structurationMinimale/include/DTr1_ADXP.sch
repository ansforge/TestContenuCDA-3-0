...
<rule xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="ADXP">
   ...
   <assert role="error" test="not($set_other[.=$value])" see="https://docs.art-decor.org/documentation/datatypes/DTr1_ADXP">dtr1-1-ADXP: [RIM-002] <name/> (<value-of select="$value"/>) SHALL be distinct</assert>
</rule>