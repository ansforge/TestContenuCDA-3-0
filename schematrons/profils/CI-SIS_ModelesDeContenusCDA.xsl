...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">E_instructionAuPatient_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M99"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_scoreNIHSS_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M100"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOMExpositionPatient_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M101"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOMAdministrationProduitDeSante_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M102"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOMAdministrationRadiopharmaceutique_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M103"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOM_Observation_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M104"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOM_Quantite_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M105"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOM_TechniqueImagerie_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M106"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOMExamenImagerie_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M107"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOM_SerieImagerie_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M108"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_DICOM_SOPInstanceObservation_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M109"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculaireAlignementOculaireEtMotilite_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M110"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculaireChampVisuel_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M111"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculairePressionIntraoculaire_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M112"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculairePupilles_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M113"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculaireSegmentAnterieur_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M114"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculaireSystemeLacrymal_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M115"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_observationOculaireTestDeLaVision_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M116"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_ocularObservation_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M117"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_auteurAPSR_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M118"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_batterieExamensSurveillancePrenataux_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M119"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_informantAPSR_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M120"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_laboratoireExecutant_fr</xsl:attribute>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">E_humanPatientWithNonHumanSubject_fr</xsl:attribute>
            <svrl:text>Contrôle d'un élément FR-Patient-avec-sujet-non-humain dans un élément Sujbect</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M122"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_nonHumanSubject_fr</xsl:attribute>
            <svrl:text>Contrôle d'un élément FR-Sujet-non-humain dans un élément Sujbect</svrl:text>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M123"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_rechercheMicroOrganismes_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M124"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_motifArretTraitement_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M125"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_modaliteSortie_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M126"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">E_modaliteEntree_fr</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:entryRelationship/*/cda:templateId[@root='1.2.250.1.213.1.1.3.171'])&lt;2"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code='118215003' and @codeSystem='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:subject[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.15.2']/cda:relatedSubject/cda:code[@code='CHILD' and @codeSystem='2.16.840.1.113883.5.111']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.2.250.1.213.1.1.3.57']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:author) or (cda:author/@typeCode=&#34;AUT&#34; and cda:author/@contextControlCode=&#34;OP&#34;)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS entrée "FR-Instructions-au-patient"</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.33']" priority="1000"
                 mode="M16">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.2.250.1.213.1.1.3.33']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:templateId[@root='1.2.250.1.213.1.1.3.33'])&lt;=1 and cda:templateId[@root='2.16.840.1.113883.10.20.1.49'] and cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.3']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
          ...
          [E_instructionsPatient_fr.sch] Erreur de conformité CI-SIS : 
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.35']) or (cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.35']/cda:code[@code='PINSTRUCT' and @codeSystem='1.3.6.1.4.1.19376.1.5.3.2'])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS Entrée "FR-Instructions-au-dispensateur"</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.34']" priority="1000"
                 mode="M17">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.2.250.1.213.1.1.3.34']"/>
...
<xsl:if test="cda:templateId[@root !='2.16.840.1.113883.10.20.1.34'             and @root !='1.3.6.1.4.1.19376.1.5.3.1.4.7.3'             and @root !='1.2.250.1.213.1.1.3.44']">
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.7&#34;]/cda:entryRelationship[@typeCode=&#34;SUBJ&#34; and cda:templateId/@root!=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.2&#34;]/cda:act"
                 priority="1005"
                 mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.7&#34;]/cda:entryRelationship[@typeCode=&#34;SUBJ&#34; and cda:templateId/@root!=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.2&#34;]/cda:act"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:act/cda:text) or (cda:act/cda:text and cda:act/cda:text/cda:reference/@value)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:participant[@typeCode='DST'])&lt;=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:template match="*[cda:templateId/@root=&#34;1.3.6.1.4.1.19376.1.5.3.1.4.13.5.1&#34;]"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:code[@code='118185001' and @codeSystem='2.16.840.1.113883.6.96'])=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5']//*[cda:templateId/@root='1.2.250.1.213.1.1.3.171']"
                 priority="1000"
                 mode="M25">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5']//*[cda:templateId/@root='1.2.250.1.213.1.1.3.171']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            Son attribut 'typeCode' prendra alors la valeur 'SUBJ' et l'attribut 'inversionInd' prendra la valeur 'true'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M25"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:name)=1 or cda:name[@nullFlavor='NA']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entryRelationship[@typeCode='REFR']/cda:substanceAdministration[cda:templateId/@root='1.2.250.1.213.1.1.3.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS Severity</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.29&#34;]" priority="1000"
                 mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.29&#34;]"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.1'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:template match="//cda:section[cda:templateId[@root='1.2.250.1.213.1.1.2.171']]/cda:entry/cda:substanceAdministration[cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.2']]"
      ...
      <xsl:variable name="count_ER_HorsAMM"
                    select="count(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.12']])"/>
      <xsl:variable name="count_ER_EnRapportAT"
                    select="count(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.14']])"/>
      <xsl:variable name="count_ER_NonRemboursable"
                    select="count(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.15']])"/>
      <xsl:variable name="count_ER_EnRapportALD"
                    select="count(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.13']])"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_ER_HorsAMM=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_ER_EnRapportALD=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_ER_EnRapportAT=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_ER_NonRemboursable=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
	  ...
	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.83.1']" priority="1000"
                 mode="M34">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.2.250.1.213.1.1.3.83.1']"/>
      <xsl:variable name="count_E_traitementPrescritSub"
                    select="count(self::cda:substanceAdministration/cda:templateId[@root='1.2.250.1.213.1.1.3.83.1'])"/>
      ...
      <xsl:variable name="count_rateQuantity_high" select="count(cda:rateQuantity/cda:high)"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($count_E_traitementPrescritSub&gt;=1 and parent::cda:entryRelationship[@typeCode='COMP']) or ($count_E_traitementPrescritSub=0)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count($count_id)&gt;=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count($count_text)=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count($count_referenceText)=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:consumable[@typeCode='CSM']/cda:manufacturedProduct/cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.2']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code='85353-1' and @codeSystem='2.16.840.1.113883.6.1']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:entryRelationship[@typeCode='COMP']/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.10.4.1'])&lt;=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDocument_fr] Erreur de Conformité CI-SIS: L'élément "text" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDocument_fr] Erreur de Conformité CI-SIS: L'élément "reference" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.13'] and cda:templateId[@root='1.2.250.1.213.1.1.3.48']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:participant/cda:participantRole/cda:playingEntity) or (cda:participant/cda:participantRole/cda:playingEntity[@classCode=&#34;PLC&#34; and @determineCode=&#34;INST)&#34;])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:templateId[@root='1.2.250.1.213.1.1.3.46'])&lt;=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(self::cda:participant[@typeCode='DEV'] and cda:participantRole/cda:playingEntity) or (self::cda:participant[@typeCode='DEV']and cda:participantRole/cda:playingDevice)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:code)=1 and cda:code/@code='11341-5'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:entryRelationship[@typeCode='COMP']/observation[cda:templateId/@root='1.2.250.1.213.1.1.3.111'])=6"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.204']" priority="1000"
      ...
      <xsl:variable name="count_id" select="count(cda:id)"/>
      <xsl:variable name="count_code" select="count(cda:code)"/>
      <xsl:variable name="count_text" select="count(cda:text)"/>
      <xsl:variable name="count_textReference" select="count(cda:text/cda:reference)"/>
      <xsl:variable name="count_quantity" select="count(cda:quantity)"/>
      <xsl:variable name="count_referenceItemPresc"
                    select="count(cda:entryRelationship[@typeCode='REFR' and cda:substanceAdministration/cda:templateId/@root='1.2.250.1.213.1.1.3.90'])&lt;=1"/>
      <xsl:variable name="count_traitement"
                    select="count(cda:entryRelationship[@typeCode='COMP' and cda:substanceAdministration/cda:templateId/@root='1.2.250.1.213.1.1.3.42'])&lt;=1"/>
      <xsl:variable name="count_insctructionPatient"
                    select="count(cda:entryRelationship[@typeCode='SUBJ' and cda:substanceAdministration/cda:templateId/@root='1.2.250.1.213.1.1.3.33'])&lt;=1"/>
      <xsl:variable name="count_notesDispensateur"
                    select="count(cda:entryRelationship[@typeCode='SUBJ' and cda:substanceAdministration/cda:templateId/@root='1.2.250.1.213.1.1.3.207'])&lt;=1"/>
      <xsl:variable name="count_acteSubstitution"
                    select="count(cda:entryRelationship[@typeCode='COMP' and cda:substanceAdministration/cda:templateId/@root='1.2.250.1.213.1.1.3.206'])&lt;=1"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:templateId[@root='1.2.250.1.213.1.1.3.204'])&lt;=1 and cda:templateId[@root='1.3.6.1.4.1.19376.1.9.1.3.4'] and cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.7.3'] and cda:templateId[@root='2.16.840.1.113883.10.20.1.34']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_textReference=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_referenceItemPresc"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_traitement"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_insctructionPatient"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_notesDispensateur"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="$count_acteSubstitution"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:value/cda:low)=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:value/cda:high)&lt;1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationAnatomoPathologique_fr.sch] Erreur de conformité CI-SIS : 
            L'entrée "FR-Observation-Anatomo-pathologique" peut contenir un élément "interpretationCode" (cardinalité [0..1]).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationAnatomoPathologique_fr.sch] Erreur de conformité CI-SIS : 
            L'entrée "FR-Observation-Anatomo-pathologique" peut contenir un élément "methodCode" (cardinalité [0..1]).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationAnatomoPathologique_fr.sch] Erreur de conformité CI-SIS : 
            L'entrée "FR-Observation-Anatomo-pathologique" peut contenir un élément "performer" (cardinalité [0..1]).</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M93"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code/@code='FINSTRUCT' and cda:code/@codeSystem='1.3.6.1.4.1.19376.1.5.3.2'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_instructionAuPatient_frIHE PCC Entrée FR-Instruction-au-patient-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">IHE PCC Entrée FR-Instruction-au-patient</svrl:text>
...
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.48.35']" priority="1000"
      ...
      <xsl:variable name="count_code"
                    select="count(//cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.35']]/cda:code[@code='PINSTRUCT'][@codeSystem='1.3.6.1.4.1.19376.1.5.3.2'])"/>
      <xsl:variable name="count_text"
                    select="count(//cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.35']]/cda:text)"/>
      <xsl:variable name="count_reference"
                    select="count(//cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.35']]/cda:text/cda:reference)"/>
      <xsl:variable name="count_statusCode"
                    select="count(//cda:entryRelationship/cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.35']]/cda:statusCode[@code='completed'])"/>
      <xsl:variable name="count_ER_InstructPatient"
                    select="count(//self::cda:entryRelationship[cda:observation[cda:templateId[@root='1.2.250.1.213.1.1.3.48.35']]])"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_scoreNIHSS_frVérification de la conformité de l'entrée FR-Score-NIHSS (1.2.250.1.213.1.1.3.6) -->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Score-NIHSS (1.2.250.1.213.1.1.3.6) </svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.6&#34;]" priority="1001"
                 mode="M100">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_scoreNIHSS_fr.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Score-NIHSS, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='72089-6'][@codeSystem='2.16.840.1.113883.6.1'])=1 and cda:code/@code='72089-6' and cda:code/@codeSystem='2.16.840.1.113883.6.1')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship[cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.8']]) or (cda:entryRelationship/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.8'])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOMExpositionPatient_frVérification de la conformité de l'entrée FR-DICOM-Exposition-patient aux spécifications DICOM-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-DICOM-Exposition-patient aux spécifications DICOM</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.165']" priority="1000"
                 mode="M101">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.165']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="self::cda:procedure[@classCode ='PROC' and @moodCode = 'EVN'] "/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root = '1.2.250.1.213.1.1.3.165']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code/@code='121290' and cda:code/@codeSystem='1.2.840.10008.2.16.4'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOMAdministrationProduitDeSante_frVérification de la conformité de l'entrée FR-DICOM-Administration-produit-de-sante aux spécifications DICOM-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-DICOM-Administration-produit-de-sante aux spécifications DICOM</svrl:text>
...
<xsl:template match="*[cda:templateId/@root = '1.2.840.10008.9.13']" priority="1000"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="self::cda:substanceAdministration[@classCode ='SBADM' and (@moodCode = 'EVN' or @moodCode='fr')] "/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root = '1.2.250.1.213.1.1.3.151']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOMAdministrationRadiopharmaceutique_frVérification de la conformité de l'entrée FR-DICOM-Administration-radiopharmaceutique aux spécifications DICOM-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-DICOM-Administration-radiopharmaceutique aux spécifications DICOM</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.173']" priority="1000"
                 mode="M103">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.173']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root = '1.2.250.1.213.1.1.3.173']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code/@code='440252007' and cda:code/@codeSystem='2.16.840.1.113883.6.96'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:consumable[@typeCode='CSM'])=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:consumable[@typeCode='CSM']/cda:manufacturedProduct"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:consumable[@typeCode='CSM']/cda:manufacturedProduct/cda:manufacturedMaterial/cda:code"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_DICOM_Observation_fr DICOM Part 20 - Coded Observation -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_Observation_fr] Erreur de conformité DICOM : Dans l'entrée "Coded Observation", l'attribut "classCode" est fixé à la valeur "OBS" et l'attribut "moodCode" doit etre présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.6.2.13' and cda:templateId/@root='1.2.250.1.213.1.1.3.150'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_Observation_fr] Erreur de conformité DICOM : Dans l'entrée "Coded Observation", il doit y avoir un seul identifiant "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOM_Quantite_fr DICOM Part 20 - FR-DICOM-Quantite -->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl"> DICOM Part 20 - FR-DICOM-Quantite </svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_Quantite_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-Quantite", l'attribut "classCode" est fixé à la valeur "OBS" et l'attribut "moodCode" est fixé à la valeur "EVN".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.6.2.14' and cda:templateId/@root='1.2.250.1.213.1.1.3.154'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_Quantite_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-Quantite", il doit y avoir un seul identifiant "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOM_TechniqueImagerie_fr DICOM Part 20 - Procedure Technique -->
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_TechniqueImagerie_fr] Erreur de conformité DICOM : Dans l'entrée "Procedure Technique", l'attribut "classCode" est fixé à la valeur "PROC" et l'attribut "moodCode" doit etre présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId/@root='1.2.250.1.213.1.1.3.153'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_TechniqueImagerie_fr] Erreur de conformité DICOM : Dans l'entrée "Procedure Technique", il doit y avoir un seul identifiant "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOMExamenImagerie_frVérification de la conformité de l'entrée FR-DICOM-Examen-imagerie aux spécifications DICOM-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-DICOM-Examen-imagerie aux spécifications DICOM</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOMExamenImagerie_fr] Erreur de conformité : L'élément "observation"
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root = '1.2.250.1.213.1.1.3.155']and cda:templateId[@root='1.2.840.10008.9.16']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_DICOMExamenImagerie_fr] Erreur de conformité DICOM : L'entrée 'FR-DICOM-Examen-imagerie' 
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_DICOMExamenImagerie_fr] Erreur de conformité DICOM : L'entrée 'FR-DICOM-Examen-imagerie' doit contenir un ou plusieurs élement(s) "id" [1..*].
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_DICOMExamenImagerie_fr] Erreur de conformité DICOM : L'entrée 'FR-DICOM-Examen-imagerie' doit contenir un élement "code" 
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:entryRelationship[@typeCode='COMP']/cda:act[cda:templateId/@root='1.2.250.1.213.1.1.3.156']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_DICOMExamenImagerie_fr] Erreur de conformité CI-SIS : L'entrée 'FR-DICOM-Serie-imagerie' doit être présente, l'attribut @typeCode doit avoir la valeur suivante 'COMP'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_DICOM_SerieImagerie_fr DICOM Part 20 - FR-DICOM-Serie-imagerie -->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl"> DICOM Part 20 - FR-DICOM-Serie-imagerie </svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_SerieImagerie_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-Serie-imagerie", les attributs "classCode" et "moodCode" doivent etre présents.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId/@root='1.2.840.10008.9.17' and cda:templateId/@root='1.2.250.1.213.1.1.3.156'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_SerieImagerie_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-Serie-imagerie", il doit y avoir un ou plusieurs éléments "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_DICOM_SOPInstanceObservation_fr DICOM Part 20 - FR-DICOM-SOP-instance-observation -->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl"> DICOM Part 20 - FR-DICOM-SOP-instance-observation </svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_SOPInstanceObservation_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-SOP-instance-observation", l'attribut "classCode" est fixé à la valeur "DGIMG" et l'attribut "moodCode" est fixé à la valeur "EVN".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_DICOM_SOPInstanceObservation_fr] Erreur de conformité DICOM : Dans l'entrée "FR-DICOM-SOP-instance-observation", il doit y avoir au moins un identifiant "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_observationOculaireAlignementOculaireEtMotilite_frVérification de la conformité de l'entrée FFR-Observation-oculaire-alignement-oculaire-et-motilite spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FFR-Observation-oculaire-alignement-oculaire-et-motilite spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.6']" priority="1000"
                 mode="M110">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.6']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.3.6.1.4.1.19376.1.12.1.3.1']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireAlignementOculaireEtMotilite_fr] Erreur de conformité CI-SIS : 
            L'entrée FFR-Observation-oculaire-alignement-oculaire-et-motilite doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[(@code ='251781009'or @code='313088003' or @code='31763002' or @code='400927000') and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:targetSiteCode[(@code='362503005' or @code='362502000') and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            (@code='362503005' or  @code='362503005'or @code='362508001') et @codeSystem="2.16.840.1.113883.6.96"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M110"/>
   ...
   <!--PATTERN E_observationOculaireChampVisuel_frVérification de la conformité de l'entrée FFR-Observation-oculaire-champ-visuel spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FFR-Observation-oculaire-champ-visuel spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.2']" priority="1000"
                 mode="M111">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.2']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireChampVisuel_fr] Erreur de conformité CI-SIS : 
            L'entrée FFR-Observation-oculaire-champ-visuel doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code ='421640006'and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_observationOculairePressionIntraoculaire_frVérification de la conformité de l'entrée FR-Observation-oculaire-pression-intraoculaire spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire-pression-intraoculaire spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.4']" priority="1000"
                 mode="M112">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.4']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : L'élément "observation" doit
            contenir les attributs @classCode="OBS" et @moodCode="EVN". </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pression-intraoculaire doit comporter le 'templateId' IHE EYE CARE GEE  avec l'attribut suivant : @root=' 1.3.6.1.4.1.19376.1.12.1.3.1'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pression-intraoculaire doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code ='41633001'and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-pression-intraoculaire doit contenir l'élément "code" avec les attributs :
            @code ='41633001'and @codeSystem ='2.16.840.1.113883.6.96'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-pression-intraoculaire doit contenir
            l'élément "statusCode" avec l'attribut @code fixé à "completed".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pression-intraoculaire doit contenir un élément "effectiveTime" avec
            l'attribut @value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePressionIntraoculaire_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pression-intraoculaire doit contenir un élément "targetSiteCode" avec les attributs 
            (@code='362503005' or  @code='362503005') et @codeSystem="2.16.840.1.113883.6.96"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M112"/>
   ...
   <!--PATTERN E_observationOculairePupilles_frVérification de la conformité de l'entrée FR-Observation-oculaire-pupilles spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire-pupilles spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.8']" priority="1000"
                 mode="M113">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.8']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : L'élément "observation" doit
            contenir les attributs @classCode="OBS" et @moodCode="EVN". </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pupilles doit comporter le 'templateId' IHE EYE CARE GEE  avec l'attribut suivant : @root=' 1.3.6.1.4.1.19376.1.12.1.3.1'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pupilles doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[(             @code ='363953003'             or @code='363954009'              or @code='3363955005'              or @code='113147002')             and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-pupilles doit contenir l'élément "code".
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-pupilles doit contenir
            l'élément "statusCode" avec l'attribut @code fixé à "completed".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pupilles doit contenir un élément "effectiveTime" avec
            l'attribut @value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculairePupilles_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-pupilles doit contenir un élément "targetSiteCode" avec les attributs 
            (@code='362503005' or  @code='362503005' or @code='362508001') et @codeSystem="2.16.840.1.113883.6.96"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_observationOculaireSegmentAnterieur_frVérification de la conformité de l'entrée FR-Observation-oculaire-segment-anterieuraux spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire-segment-anterieuraux spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.1']" priority="1000"
                 mode="M114">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.1']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : L'élément "observation" doit
            contenir les attributs @classCode="OBS" et @moodCode="EVN". </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-segment-anterieuraux doit comporter le 'templateId' IHE EYE CARE GEE  avec l'attribut suivant : @root=' 1.3.6.1.4.1.19376.1.12.1.3.1'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-segment-anterieuraux doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[(             @code ='420160007'             or @code='251693007'              or @code='363940001'              or @code='363940001'              or @code ='363964000'             or @code='363943004'              or @code='363946007'              or @code='363956006'             or @code='363959004'             or @code='3363965004'             or @code='363949000')             and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : L'entrée
            FR-Observation-oculaire-segment-anterieuraux doit contenir l'élément "code".
            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-segment-anterieuraux doit contenir
            l'élément "statusCode" avec l'attribut @code fixé à "completed".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-segment-anterieuraux doit contenir un élément "effectiveTime" avec
            l'attribut @value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSegmentAnterieur_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-segment-anterieuraux doit contenir un élément "targetSiteCode" avec les attributs 
            (@code='362503005' or  @code='362503005' or @code='362508001') et @codeSystem="2.16.840.1.113883.6.96"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_observationOculaireSystemeLacrymal_frVérification de la conformité de l'entrée FR-Observation-oculaire-test-de-la-vision aux spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire-test-de-la-vision aux spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.5']" priority="1000"
                 mode="M115">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.5']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : L'élément "observation" doit
            contenir les attributs @classCode="OBS" et @moodCode="EVN". </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-systeme-lacrymal doit comporter le 'templateId' IHE EYE CARE GEE  avec l'attribut suivant : @root=' 1.3.6.1.4.1.19376.1.12.1.3.1'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-systeme-lacrymal doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[(@code ='417323003'or @code='64702000' or @code='251693007') and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : L'entrée
            FR-Observation-oculaire-systeme-lacrymal doit contenir l'élément "code" avec les attributs
            (@code ='417323003'or @code='64702000' or @code='251693007') et @codeSystem="2.16.840.1.113883.6.96".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-systeme-lacrymal doit contenir
            l'élément "statusCode" avec l'attribut @code fixé à "completed".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire-systeme-lacrymal doit contenir l'élément "value".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-systeme-lacrymal doit contenir un élément "effectiveTime" avec
            l'attribut @value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_observationOculaireSystemeLacrymal_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire-systeme-lacrymal doit contenir un élément "targetSiteCode" avec les attributs 
            (@code='362503005' or  @code='362503005' or @code='362508001') et @codeSystem="2.16.840.1.113883.6.96"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN E_observationOculaireTestDeLaVision_frVérification de la conformité de l'entrée FR-Observation-oculaire-test-de-la-vision aux spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire-test-de-la-vision aux spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.9']" priority="1000"
                 mode="M116">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114.9']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            ...
            FR-Observation-oculaire-test-de-la-vision doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[(@code ='271726001'or @code='251686008' or @code='359750002' or @code='78513008') and @codeSystem ='2.16.840.1.113883.6.96']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            (@code ='271726001'or @code='251686008' or @code='359750002' or @code='78513008') et @codeSystem="2.16.840.1.113883.6.96".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
   ...
   <!--PATTERN E_ocularObservation_frVérification de la conformité de l'entrée FR-Observation-oculaire aux spécifications CI-SIS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Observation-oculaire aux spécifications CI-SIS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114']" priority="1000"
                 mode="M117">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.114']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'élément "observation" doit
            contenir les attributs @classCode="OBS" et @moodCode="EVN". </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr]  Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire doit comporter le 'templateId' IHE EYE CARE GEE  avec l'attribut suivant : @root=' 1.3.6.1.4.1.19376.1.12.1.3.1'.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée
            FR-Observation-oculaire doit contenir au minimum un élément "id".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée
            FR-Observation-oculaire doit contenir l'élément "code".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire doit contenir l'élément "text".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire doit contenir l'élément "text/reference".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire doit contenir l'élément "statusCode" avec l'attribut @code fixé à "completed".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text> 
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : L'entrée FR-Observation-oculaire doit contenir l'élément "value".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire doit contenir un élément "effectiveTime" avec l'attribut @value.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_ocularObservation_fr] Erreur de conformité CI-SIS : 
            L'entrée FR-Observation-oculaire doit contenir un élément "targetSiteCode" avec les attributs 
   ...
   <!--PATTERN E_auteurAPSR_frCI-SIS "L'élément FR-Auteur-APSR "-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS "L'élément FR-Auteur-APSR "</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.160']" priority="1000"
                 mode="M118">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.2.250.1.213.1.1.3.160']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.3.6.1.4.1.19376.1.8.1.4.2']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:assignedAuthor/cda:id)&gt;=1 "/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_batterieExamensSurveillancePrenataux_frVérification de la conformité de  l'entrée FR-Batterie-Examens-et-surveillance-prenataux-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de  l'entrée FR-Batterie-Examens-et-surveillance-prenataux</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.98&#34;]" priority="1000"
                 mode="M119">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.98&#34;]"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_informantAPSR_frCI-SIS "L'élément FR-Informant-APSR "-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS "L'élément FR-Informant-APSR "</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.161']" priority="1000"
                 mode="M120">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root='1.2.250.1.213.1.1.3.161']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.3.6.1.4.1.19376.1.8.1.4.6']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_laboratoireExecutant_fr-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:assignedEntity/cda:representedOrganization/cda:id and             cda:assignedEntity/cda:representedOrganization/cda:name and count(cda:assignedEntity/cda:representedOrganization/cda:telecom)&gt;=1 and cda:assignedEntity/cda:representedOrganization/cda:standardIndustryClassCode and count(cda:assignedEntity/cda:representedOrganization/cda:addr)&gt;=1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN E_humanPatientWithNonHumanSubject_fr-->


	<!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.101']" priority="1000"
                 mode="M122">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.101']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root=&#34;1.3.6.1.4.1.19376.1.3.3.1.3.1&#34;]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_nonHumanSubject_fr-->


	<!--RULE -->
<xsl:template match="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.22']" priority="1000"
                 mode="M123">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = '1.2.250.1.213.1.1.3.22']"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_rechercheMicroOrganismes_frVérification de la conformité de l'entrée FR-Recherche-de-micro-organismes (1.2.250.1.213.1.1.3.48.8)-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Recherche-de-micro-organismes (1.2.250.1.213.1.1.3.48.8)</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.8&#34;]" priority="1000"
                 mode="M124">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.8&#34;]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_rechercheMicroOrganismes_fr.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Recherche-de-micro-organismes, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='MED-309'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1 and cda:code/@code='MED-309' and cda:code/@codeSystem='1.2.250.1.213.1.1.4.322')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_motifArretTraitement_frVérification de la conformité de l'entrée FR-Motif-arret-traitement (1.2.250.1.213.1.1.3.48.17)-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Motif-arret-traitement (1.2.250.1.213.1.1.3.48.17)</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.17&#34;]" priority="1000"
                 mode="M125">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.17&#34;]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_motifArretTraitement_fr.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Motif-arret-traitement, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:code)=1 and cda:code/@code='MED-052'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_modaliteSortie_frVérification de la conformité de l'entrée FR-Modalite-sortie (1.2.250.1.213.1.1.3.48.7) créée par l'ANS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Modalite-sortie (1.2.250.1.213.1.1.3.48.7) créée par l'ANS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.7&#34;]" priority="1000"
                 mode="M126">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.7&#34;]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_modaliteSortie_fr.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Modalite-sortie, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:code)=1 and cda:code/@code='ORG-074'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN E_modaliteEntree_frVérification de la conformité de l'entrée FR-Modalite-entree (1.2.250.1.213.1.1.3.48.6) créée par l'ANS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Modalite-entree (1.2.250.1.213.1.1.3.48.6) créée par l'ANS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.6&#34;]" priority="1000"
                 mode="M127">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root=&#34;1.2.250.1.213.1.1.3.48.6&#34;]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_modaliteEntree_fr.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Modalite-entree, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:code)=1 and cda:code/@code='ORG-070'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
