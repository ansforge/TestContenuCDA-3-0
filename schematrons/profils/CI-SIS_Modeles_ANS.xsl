...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">S_documentPDFCopie_ANS</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
   ...
   <!--PATTERN S_documentPDFCopie_ANSVérification de la conformité de la section FR-Document-PDF-copie (1.2.250.1.213.1.1.2.243) créée par l'ANS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de la section FR-Document-PDF-copie (1.2.250.1.213.1.1.2.243) créée par l'ANS</svrl:text>

	  <!--RULE -->
<xsl:template match="*[cda:templateId/@root = &#34;1.2.250.1.213.1.1.2.243&#34;]" priority="1000"
                 mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[cda:templateId/@root = &#34;1.2.250.1.213.1.1.2.243&#34;]"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:title = &#34;Copie du document&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code =&#34;55108-5&#34;]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.13']) or cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.13']/cda:code[@code='MED-574']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.14']) or cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.14']/cda:code[@code='GEN-180']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.34']) or cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.34']/cda:code[@code='GEN-295']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not(cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.215']) or cda:entryRelationship[@typeCode='COMP']/cda:observation[cda:templateId/@root='1.2.250.1.213.1.1.3.48.215']/cda:code[@code='GEN-181']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
                ...
                L'entrée "FR-En-rapport-avec-accident-travail" peut comporter un élément 'effectiveTime' [0..1].
            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='MED-574'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:template match="*[cda:templateId/@root='1.2.250.1.213.1.1.3.48.12']" priority="1000"
      ...
      <xsl:variable name="count_valueFalse" select="(count(cda:value[@value='false']))"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root='1.2.250.1.213.1.1.3.48'] and cda:templateId[@root='1.3.6.1.4.1.19376.1.5.3.1.4.13']  and cda:templateId[@root='1.2.250.1.213.1.1.3.48.12']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='GEN-179'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='GEN-181'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
                ...
                L'entrée "FR-Non-remboursable" peut comporter un élément 'effectiveTime' [0..1].
            </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">CI-SIS Statut du dossier</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code/@code=&#34;GEN-099&#34; and cda:code/@codeSystem=&#34;1.2.250.1.213.1.1.4.322&#34;"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            L'élément 'code' doit être obligatoirement 'GEN-099' et l'élément codeSystem '1.2.250.1.213.1.1.4.322'.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "statusCode" sera présent et prendra la valeur "completed"</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "code" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "text" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "text/reference" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "effectiveTime" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_statutDuDossier_ANS] Erreur de conformité CI-SIS: L'élément "value" doit être présent.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*|comment()|processing-instruction()" mode="M62"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Type-document-attache (1.2.250.1.213.1.1.3.48.18) créée par l'ANS</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_typeDocumentAttache_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Type-document-attache, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='69764-9'][@codeSystem='2.16.840.1.113883.6.1'])=1 and cda:code/@code='69764-9' and cda:code/@codeSystem='2.16.840.1.113883.6.1')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Transfusion-de-produits-sanguins (1.2.250.1.213.1.1.3.48.10) créée par l'ANS</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, il doit y avoir un élément id (cardinalité [1..1])
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, il doit y avoir le templateId  (’1.3.6.1.4.1.19376.1.5.3.1.4.13’)
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='MED-145'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1 and cda:code/@code='MED-145' and cda:code/@codeSystem='1.2.250.1.213.1.1.4.322')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : 
            L'entrée "FR-Transfusion-de-produits-sanguins" doit comporter un élément 'code' avec les attributs :
            - @code="MED-145" (cardinalité [1..1])
            - @codeSystem="1.2.250.1.213.1.1.4.322" (cardinalité [1..1])
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, le statusCode doit présent et fixé à la valeur @code='completed'
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, un élément text doit être présent 
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, un élément effectiveTime doit être présent 
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_transfusionProduitsSanguins_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Transfusion-de-produits-sanguins, un élément value doit être présent 
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de la conformité de l'entrée FR-Synthese-medicale-sejour (1.2.250.1.213.1.1.3.48.9) créée par l'ANS</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               ...
               <svrl:text>
            [E_syntheseMedicaleSejour_ANS.sch] Erreur de conformité CI-SIS : Dans l'entrée FR-Synthese-medicale-sejour, les attributs @classCode, @moodCode de l'élément observation sont fixés resectivement aux valeurs 'OBS', 'EVN'</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(count(cda:code[@code='MED-142'][@codeSystem='1.2.250.1.213.1.1.4.322'])=1 and cda:code/@code='MED-142' and cda:code/@codeSystem='1.2.250.1.213.1.1.4.322')"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
