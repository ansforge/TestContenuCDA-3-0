...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CI-SIS_IMG-CR-IMG_2022.01"
    ...
    <!-- JDV -->
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_ModaliteImagerie-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_ModaliteImagerieDocumentationOf-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_ModaliteAcquisition-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_LateraliteTechniqueImagerie-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_QuantiteExpositionRayonnements-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_contre-indications-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_StatutGrossesse-CISIS.sch"/>
    <include href="include/jeuxDeValeurs/CI-SIS_IMG-CR-IMG_2022.01/JDV_ImagerieObjectifsReference-CISIS.sch"/>
 
    
    <!-- Entete -->
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Entete/Entete_IMG-CR-IMG.sch"/>
    
    <!-- Sections -->
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_CommentaireNonCodee_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_Addendum_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_Conclusion_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_ExamenComparatif_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_ActeImagerie_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_ExpositionsAuxRadiations_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_CatalogueObjets_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_InformationClinique_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_HistoriqueMedical_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_Complications_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Sections/S_DICOM_Resultat_IMG-CR-IMG.sch"/>
    
    <!-- Entrées -->
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Entrees/E_TechniqueImagerie_IMG-CR-IMG.sch"/>
    <include href="include/specificationsVolets/CI-SIS_IMG-CR-IMG_2022.01/Entrees/E_ExamenImagerie_IMG-CR-IMG.sch"/>
    ...
    <phase id="CI-SIS_IMG-CR-IMG_2022.01">
        ...
        <active pattern="S_DICOM_CommentaireNonCodee_IMG-CR-IMG"/>
