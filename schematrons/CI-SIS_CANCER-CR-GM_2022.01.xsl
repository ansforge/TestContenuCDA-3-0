...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rapport de conformité du document aux spécifications du volet
                CANCER-CR-GM_2022.01</svrl:text>
...
<xsl:choose>
   ...
   <!--PATTERN JDV_TypeHistoEtatTumoral-CISIS-->
	...
	<!--RULE -->
<xsl:template match="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:organizer/cda:component/cda:observation[cda:code/@code='33731-1']/cda:value"
                 priority="1000"
                 mode="M24">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:organizer/cda:component/cda:observation[cda:code/@code='33731-1']/cda:value"/>
      <xsl:variable name="att_code" select="@code"/>
      <xsl:variable name="att_codeSystem" select="@codeSystem"/>
      <xsl:variable name="att_displayName" select="@displayName"/>
...
<xsl:variable name="JDV_Conditionnement-CISIS"
                 select="'../jeuxDeValeurs/JDV_Conditionnement_CISIS.xml'"/>
   <xsl:variable name="JDV_ClasseTherapie-CISIS"
                 select="'../jeuxDeValeurs/JDV_ClasseTherapie_CISIS.xml'"/>
   <xsl:variable name="JDV_ImpactMutation-CISIS"
                 select="'../jeuxDeValeurs/JDV_ImpactMutation_CISIS.xml'"/>
   <xsl:variable name="JDV_MethodePreparationEchantillon-CISIS"
                 select="'../jeuxDeValeurs/JDV_MethodePreparationEchantillon_CISIS.xml'"/>
   <xsl:variable name="JDV_NatureFraction-CISIS"
                 select="'../jeuxDeValeurs/JDV_NatureFraction_CISIS.xml'"/>
   <xsl:variable name="JDV_NatureMaterielEtudie-CISIS"
                 select="'../jeuxDeValeurs/JDV_NatureMaterielEtudie_CISIS.xml'"/>
   <xsl:variable name="JDV_Organe-CISIS" select="'../jeuxDeValeurs/JDV_Organe_CISIS.xml'"/>
   <xsl:variable name="JDV_QualificationFraction-CISIS"
                 select="'../jeuxDeValeurs/JDV_QualificationFraction_CISIS.xml'"/>
   <xsl:variable name="JDV_RaisonNonRealisation-CISIS"
                 select="'../jeuxDeValeurs/JDV_RaisonNonRealisation_CISIS.xml'"/>
   <xsl:variable name="JDV_TypeConclusion-CISIS"
                 select="'../jeuxDeValeurs/JDV_TypeConclusion_CISIS.xml'"/>
   <xsl:variable name="JDV_TypeHistoEtatTumoral-CISIS"
                 select="'../jeuxDeValeurs/JDV_TypeHisto_EtatTumoral_CISIS.xml'"/>
   <xsl:variable name="JDV_TypePrelevOrigine-CISIS"
                 select="'../jeuxDeValeurs/JDV_TypePrelevOrigine_CISIS.xml'"/>
   <xsl:variable name="JDV_TypeResultat-CISIS"
                 select="'../jeuxDeValeurs/JDV_TypeResultat_CISIS.xml'"/>
   <xsl:variable name="JDV_StatutDoc-CISIS" select="'../jeuxDeValeurs/JDV_StatutDoc_CISIS.xml'"/>
